...
public class HttpReqClinet {
	...
	public static <T> T postReqProxy(HostEnum host,
			MultiValueMap<String, Object> body, Class<T> responseType)
		...
		T returnObject = null;
		try {
			ResponseEntity<T> result = getRestTemplate().exchange(
					host.getRoute(), HttpMethod.POST, requestEntity,
					responseType);
	...
	public static <T> T getReqProxy(HostEnum host, String parameter,
